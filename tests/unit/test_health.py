...
def chat_use_case(provider_registry):
    ...
    # Patch the method to return mock data

    def mock_get_circuit_breaker_status():  # type: ignore[misc]
        return {
            "test-provider": {
                "state": "closed",
                "failure_count": 0,
    ...
    use_case.get_circuit_breaker_status = mock_get_circuit_breaker_status  # type: ignore[method-assign]
    return use_case
